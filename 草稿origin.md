...
会员（达人等级）可自购也可分享 短视频，直播间，商品 
两个平台：会员在【推客小程序】和【H5】有两个独立账户 小程序能做所有操作 h5页面只能看分多少钱，提现等操作
	在小程序是达人（只有他当达人的时候赚到的钱，h5） 
	在h5平台是团长 类似于小学和初中（团长所有钱能在h5看） 
	用户要被分享才可下单 分享者是上级 然后有一套绑定机制
	下单，拉起三方微信小店 我们被同步订单状态 
	灵活用工平台是三方兼职平台，推客在三方平台绑定 
	只下单购买不需要绑定要提现才绑定 只是带货平台和记账 属于多个三分平台合作的一环 

////此部分还没修改表述--end cause：下班了，先吃饭，明天继续////
```
